...
function SuperAdminNgoSingleProgram() {
  ...
  return (
    <div className="LayoutParent">
      ...
      <div>
        <AppBar position="static" className={classes.AppHead}>
          ...
          >
            <Tab
              ...
              {...a11yProps(0)}
            />
            <Tab className={classes.tabText} label="About" {...a11yProps(1)} />
          </Tabs>
        </AppBar>
            ...
            <Table className={classes.table} aria-label="simple table">
              <TableHead className={classes.tableHead}>
                <TableRow>
                  ...
                  <TableCell className={classes.ListHead}>Gender</TableCell>
                  <TableCell className={classes.ListHead}>Age</TableCell>
                  <TableCell className={classes.ListHead}>Adden on</TableCell>
                ...
                <TableRow className={classes.tableShadow}>
                  ...
                  <TableCell>
                    <Typography
                      ...
                      paragraph={true}
                    >
                      <Link to="/superadmin/ngo-beneficiary">See details</Link>
                    </Typography>
                  </TableCell>
                </TableRow>
                <TableRow className={classes.tableShadow}>
        ...
        <TabPanel value={value} index={1}>
          ...
          <p className="fs14 w400 Dark">
            Mithilesh lives in Gosala village near Chouparan, Jharkhand. He had
            to discontinue his education after class V due to abject poverty. At
            that tender age, he had begun to accompany the elders of his family
            to work.
          </p>
          <p className="fs14 w400 Dark">
      ...
      <div className={styles.DialogStyles}>
        ...
        >
          <DialogContent className={classes.LgDialohPadding}>
            ...
            <h3 className={styles.dialogTitle}>Bulk upload beneficiaries</h3>
            <p className={styles.dialogSubtext}>
              Please refer to the details below for a bulk upload of entries
            </p>
            <div className={styles.dialogFormLG}>
              <h4 className="w700 fs15">How to upload</h4>
              <ol className="pl16">
                <li className="fs15 w400">
                  Either directly upload a pre-filled csv file or download a
                  template.
                </li>
                <li className="fs15 w400">
                  Fill your data in the template file.
                </li>
                <li className="fs14 w400">Upload it below for processing.</li>
              </ol>
              ...
              <div>
                <Button color="primary" variant="contained" className="px-5 ">
      ...
      <div className={styles.DialogStyles}>
        ...
        >
          <DialogContent className={classes.LgDialohPadding}>
            <span onClick={handleCloseAddNew} className={styles.DialogClose}>
              x
            </span>
...
export default SuperAdminNgoSingleProgram;
